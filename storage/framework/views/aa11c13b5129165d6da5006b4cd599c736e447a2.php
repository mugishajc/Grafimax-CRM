...
<div class="row">
    <div class="form-group  col-md-6">
        <?php echo e(Form::label('project_id', __('Client'))); ?>

        <?php echo e(Form::select('project_id', $kiriya,null, array('class' => 'form-control font-style selectric','required'=>'required'))); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
    ...
    <div class="form-group  col-md-12">
        ...
        <?php echo Form::textarea('terms', null, ['class'=>'form-control font-style','rows'=>'2']); ?>
...
<?php /**PATH D:\Projects\Laravel\Grafimax-CRM\resources\views/invoices/edit.blade.php ENDPATH**/ ?>