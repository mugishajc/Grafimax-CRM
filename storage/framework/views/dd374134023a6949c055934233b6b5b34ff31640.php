...
<div class="row">
    <div class="form-group  col-md-6">
        <?php echo e(Form::label('project_id', __('Client name'))); ?>

        <?php echo e(Form::select('project_id', $kiriya,null, array('class' => 'form-control font-style selectric'))); ?>
...
<?php /**PATH D:\Projects\Laravel\Grafimax-CRM\resources\views/invoices/create.blade.php ENDPATH**/ ?>