                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between w-100">
                            <h4><?php echo e(__('Manage Product Unit')); ?></h4>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create product unit')): ?>
                                <a href="#" class="btn btn-sm btn-warning" data-url="<?php echo e(route('productunits.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Product Unit')); ?>">
                                  <span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-July\htdocs\Laravel\Grafimax-CRM\resources\views/productunits/index.blade.php ENDPATH**/ ?>