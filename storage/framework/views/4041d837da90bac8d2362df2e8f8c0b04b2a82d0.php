                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between w-100">
                            <h4><?php echo e(__('Manage Project Stages')); ?></h4>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create lead stage')): ?>
                                <a href="#" class="btn btn-sm btn-warning" data-url="<?php echo e(route('projectstages.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Project Stage')); ?>">
                                  <span>
                                        ...
                                        <div class="constant-table">
                                            <table class="table table-striped">
                                                ...
                                                <?php $__currentLoopData = $projectstages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projectstage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr data-id="<?php echo e($projectstage->id); ?>">
                                                        <td>
                                                            <a><?php echo e($projectstage->name); ?></a>
                                                        </td>
                                                        <td>
                                                            <span class="text-muted"><?php echo e($projectstage->created_at); ?></span>
                                                        </td>
                                                        <td class="table-actions">
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit project stage')): ?>
                                                                <a href="#" class="table-action" data-url="<?php echo e(route('projectstages.edit',$projectstage->id)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Edit Project Stages')); ?>" class="table-action" data-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>"><i class="far fa-edit"></i></a>
                                                            <?php endif; ?>
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete project stage')): ?>
                                                                <a href="#" class="table-action table-action-delete" class="table-action table-action-delete" data-toggle="tooltip" data-original-title="<?php echo e(__('Delete')); ?>" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="document.getElementById('delete-form-<?php echo e($projectstage->id); ?>').submit();"><i class="far fa-trash-alt"></i></a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-July\htdocs\Laravel\Grafimax-CRM\resources\views/projectstages/index.blade.php ENDPATH**/ ?>