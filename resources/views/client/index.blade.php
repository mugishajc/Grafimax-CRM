    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{__('Client')}}</div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                        <div class="staff staff-grid-view pb-0">
                                                ...
                                                @if($client->is_active==1)
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            @can('edit user')
                                                                <a href="#" class="dropdown-item" data-url="{{ route('clients.edit',$client->id) }}" data-ajax-popup="true" data-title="{{__('Update User')}}">{{__('Edit')}}</a>
                                                            @endcan
                                                            @can('delete user')
                                                                <a class="dropdown-item" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="document.getElementById('delete-form-{{$client['id']}}').submit();">
                                            ...
                                            <div class="main-info mb-4">
                                                <h2 class="m-0 font-style   ">{{$client->name}}</h2>
                                                <p class="font-style"> {{$client->type}}</p>
                                            </div>
