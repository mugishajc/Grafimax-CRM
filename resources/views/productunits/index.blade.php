...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{__('Product Unit')}}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></div>
                <div class="breadcrumb-item">{{__('Product Unit')}}</div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between w-100">
                            <h4>{{__('Manage Product Unit')}}</h4>
                            @can('create product unit')
                                <a href="#" class="btn btn-sm btn-warning" data-url="{{ route('productunits.create') }}" data-ajax-popup="true" data-title="{{__('Create New Product Unit')}}">
                                  <span>
