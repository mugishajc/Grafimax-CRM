    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                    <div class="card-icon shadow-primary bg-primary">
                        <div class="count">{{$user['total_user']}}</div>
                    </div>
                    <div class="card-wrap">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                    <div class="card-icon shadow-primary bg-primary">
                        <div class="count">{{$user['total_orders']}}</div>
                    </div>
                    <div class="card-wrap">
                        <div class="card-header">
                    ...
                    <div class="card-stats">
                        <div class="card-stats-title">
                            <div class="progreess-status mt-2">
                                ...
                                <span><strong>{{$user['total_orders_price']}}  </strong></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                    <div class="card-icon shadow-primary bg-primary">
                        <div class="count">{{$user['total_plan']}}</div>
                    </div>
                    <div class="card-wrap">
                        <div class="card-header">
                    ...
                    <div class="card-stats">
                        <div class="card-stats-title">
                            <div class="progreess-status mt-2">
                                <span>{{__('Total Purchase Plan')}}</span>
